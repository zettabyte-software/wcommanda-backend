    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ms_codigo', models.PositiveSmallIntegerField(verbose_name='código')),
                ('ms_quantidade_lugares', models.PositiveSmallIntegerField(verbose_name='quantidade de lugares')),
                ('ms_ocupada', models.BooleanField(default=False, verbose_name='ocupada')),
                ('ms_observacao', models.CharField(blank=True, max_length=100, verbose_name='observacao')),
