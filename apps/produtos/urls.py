...
from .views import AcrescimoViewSet, CategoriaProdutoViewSet, GrupoComplementoProdutoViewSet, ProdutoViewSet
...
router_v1.register("grupo_acrescimos_produto", GrupoComplementoProdutoViewSet, "grupo_acrescimos_produto")
