    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rs_codigo', models.UUIDField(default=uuid.uuid4, verbose_name='código da reserva')),
                ('rs_cliente', models.CharField(max_length=80, verbose_name='cliente')),
                ('rs_celular_cliente', models.CharField(blank=True, default='', max_length=11, verbose_name='cliente')),
